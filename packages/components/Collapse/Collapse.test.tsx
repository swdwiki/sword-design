...
describe("Collapse.vue", () => {
  beforeAll(() => {
    ...
    headers = wrapper.findAll(".swd-collapse-item__header");
    contents = wrapper.findAll(".swd-collapse-item__wapper");
  ...
  test("手风琴模式 错误处理", () => {
    ...
    expect(warn.mock.calls).toMatchInlineSnapshot(
      `
        [
          [
            [SwdUIError: [SwdCollapse] accordion mode should only have one active item],
          ],
        ]
      `
    );
