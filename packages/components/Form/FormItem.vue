...
import { useId } from "@swd-design/hooks";
import { FORM_CTX_KEY, FORM_ITEM_CTX_KEY } from "./constants";

defineOptions({ name: "SwdFormItem" });
...
<template>
  ...
  >
    ...
    <div class="swd-form-item__content">
      <slot :validate="validate"></slot>
      <div class="swd-form-item__error-msg" v-if="validateStatus === 'error'">
...
.swd-form-item {
  --swd-form-label-width: v-bind(normalizeLabelWidth) !important;
}
</style>
