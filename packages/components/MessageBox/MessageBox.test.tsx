...
describe("MessageBox Component", () => {
  it("renders correctly", async () => {
    ...
    MessageBox(props);
    await rAF();
    const header = document.querySelector(".swd-message-box__header");
    const title = document.querySelector(".swd-message-box__title");
    const message = document.querySelector(".swd-message-box__message");
