...
import { useEventListener, useOffset } from "@swd-design/hooks";
...
<template>
  ...
  >
    ...
    >
      <swd-icon class="swd-message__icon" :icon="iconName" />
      <div class="swd-message__content">
        <slot>
          <render-vnode v-if="message" :vNode="message" />
        </slot>
      </div>
      <div class="swd-message__close" v-if="showClose">
