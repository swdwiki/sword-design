...
defineOptions({ name: "SwdSwitch", inheritAttrs: false });
...
<template>
  ...
  >
    ...
    />
    <div class="swd-switch__core">
      <div class="swd-switch__core-inner">
        <span
          v-if="activeText || inactiveText"
          class="swd-switch__core-inner-text"
        >
          {{ checked ? activeText : inactiveText }}
        </span>
      </div>
      <div class="swd-switch__core-action"></div>
    </div>
  </div>
</template>
