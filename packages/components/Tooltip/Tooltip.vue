...
import { useClickOutside } from "@swd-design/hooks";
...
<template>
  <div class="swd-tooltip" ref="containerNode" v-on="outerEvents">
    <div
      class="swd-tooltip__trigger"
      ref="_triggerNode"
      v-on="events"
